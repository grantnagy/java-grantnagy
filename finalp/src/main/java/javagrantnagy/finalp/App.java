...
public class App {
    ...
    void menu() {
        ...
        Object[] possibilities = {"Buy Coffee", "Total Cups Sold", "Total Money Made", "Total Ounces Sold", "Exit"};
    ...
    void show_total_coffee() {
        total_coffee = (small_t * small) + (medium_t * medium) + (large_t * large);
        JOptionPane.showMessageDialog(null, "Total Ounces of Coffee Sold: " + total_coffee);
        menu();
    }

    void show_total_money() {
        total_money = (small_t * dsmall) + (medium_t * dmedium) + (large_t * dlarge);
        JOptionPane.showMessageDialog(null, "Total Dollars of Coffee Sold: $" + total_money);
        menu();
    }
}
